...
class block_telegram_forum_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('text', 'config_titlename', get_string('titlename', 'block_telegram_forum'));
        $mform->setType('config_titlename', PARAM_TEXT);

        $mform->addElement('text', 'config_channelname', get_string('channelname', 'block_telegram_forum'));
        $mform->setType('config_channelname', PARAM_TEXT);
...
//            'MarkdownV2' => get_string('parse_markdown', 'block_telegram_forum'),
            );
